...
vim.keymap.set(nvo, "<a-d>", "\"_d")
vim.keymap.set(nvo, "<leader>r", "\"")

vim.keymap.set(nvo, "'", "<Plug>(easymotion-w)", {noremap = false})
vim.keymap.set(nvo, "\"", "<Plug>(easymotion-b)", {noremap = false})
