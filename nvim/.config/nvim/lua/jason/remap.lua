...
nnoremap("gx", "<cmd>lua vim.diagnostic.goto_next()<cr>")
nnoremap("gX", "<cmd>lua vim.diagnostic.goto_prev()<cr> ")
inoremap("<c-k>", "<c-o><cmd>lua vim.lsp.buf.signature_help()<CR>")
nnoremap("gqq", "<cmd>lua vim.lsp.buf.formatting()<CR>")
